...
function play(playersChoice){
    ...
    const choicesData = [
        { id: "battle-rock", img: "ASSETS/PEDRA.png", alt: "pedra", text: "Pedra" },
        { id: "battle-paper", img: "ASSETS/PAPEL.png", alt: "papel", text: "Papel" },
        { id: "battle-scissors", img: "ASSETS/TESOURA.png", alt: "tesoura", text: "Tesoura" }
    ];
